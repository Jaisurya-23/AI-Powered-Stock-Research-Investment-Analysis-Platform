...
![Platform Preview - home.png](static/images/home.png)
...
The project includes the following image files in the repository:

- Home page preview: [home.png](static/images/home.png)
  ![Home page preview](static/images/home.png)

- Company snapshot view: [company_snapshot.png](static/images/company_snapshot.png)
  ![Company snapshot view](static/images/company_snapshot.png)

- Research report view: [research_report.png](static/images/research_report.png)
  ![Research report view](static/images/research_report.png)

- Key metrics view: [key_metrics.png](static/images/key_metrics.png)
  ![Key metrics view](static/images/key_metrics.png)

- Investment checklist view: [investment_checklist.png](static/images/investment_checklist.png)
  ![Investment checklist view](static/images/investment_checklist.png)

- History page view: [history.png](static/images/history.png)
  ![History page view](static/images/history.png)
